    ...
    <PageTransition>
      <div className="max-w-5xl mx-auto space-y-12">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-syne font-bold text-slate-100 mb-4">Discover Your Next Adventure</h1>
          <p className="text-slate-400 max-w-xl mx-auto">
            Not sure where to go? Let Traveloop AI match you with the perfect destination based on your current mood.
          </p>
        </div>

        <div className="glass-card p-8 rounded-3xl border-slate-800 max-w-3xl mx-auto">
          <MoodPicker />
        </div>
      </div>
    </PageTransition>
